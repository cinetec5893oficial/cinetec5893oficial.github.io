    ...
    <main>
                ...
                <?php
                    ...
                    switch ($_REQUEST['opcion']) {
                        case "Cargar":
                            $peli->modificarPeli2($_REQUEST['codigo'],$_REQUEST['nombre'],$_REQUEST['marca'],$_REQUEST['precio'],
                            $_REQUEST['categoria'],$_REQUEST['descuento'],$_REQUEST['stock'],$_REQUEST['existencia'],$_REQUEST['descripcion'],$_REQUEST['imagen']);
                            break;
                    }
                    $peli->cerrarBD();
                 ?>
